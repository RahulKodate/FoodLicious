      ...
      <div>
        ...
        >
          <div className="justify-center items-center">
            <div
              className="text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600"
              style={{ color: "black" }}
            >
              <h1>
                The best food in the Boston you will find at our Palace
              </h1>
            </div>
            <br></br>
            <div className=" justify-center items-center flex hero-buttons mt-8">
              <Link to="/about">
                <button className="bg-green-300 text-white px-6 py-2 rounded-lg mx-2" style={{ backgroundColor: "green" }}>
                  More Info
                </button>
              </Link>
...
>
  <div className="container mx-auto">
    <h2 className="text-3xl font-bold mb-4 text-center">Top Dishes</h2>
    <p className="text-xl mb-4 text-center">Some popular and well-known dishes that you might enjoy</p>
...
<section className="testimonials bg-gray-100 py-12 px-6">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="testimonial-carousel space-x-4 flex overflow-x-scroll">
      <div className="testimonial-card w-96 p-6 bg-white shadow-lg rounded-md hover:bg-gray-200 transition duration-300">
