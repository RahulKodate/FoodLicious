...
const ContactUs = () => {
  return (
    <div>
      ...
      {/* Section 1 */}
      <section className="bg-gradient-to-r from-blue-400 to-purple-500 py-12 px-4 md:px-0">
      ...
      <section className="bg-gray-100 py-12 px-4 md:px-0">
        <div className="container mx-auto">
          ...
          <div className="flex space-x-6">
            ...
            <a href="https://facebook.com" className="text-blue-600 text-3xl hover:text-blue-800"><i className="fab fa-facebook-square"></i></a>
            <a href="https://twitter.com" className="text-blue-400 text-3xl hover:text-blue-600"><i className="fab fa-twitter-square"></i></a>
            <a href="https://instagram.com" className="text-red-600 text-3xl hover:text-red-800"><i className="fab fa-instagram-square"></i></a>
          </div>
        </div>
      </section>
